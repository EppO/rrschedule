module RRSchedule
  class Rule
    ...
    def initialize(wday: 1, game_times: [ "7:00 PM" ], playing_surfaces: [ "Field #1" ])
      self.wday             = wday
      self.game_times       = Array(game_times)
      self.playing_surfaces = Array(playing_surfaces)
    end
    ...
    def playing_surfaces=(playing_surfaces)
      @playing_surfaces = Array(playing_surfaces)
    end
